...
def run(
    ...
    train_dataset = MangaDataset(processor, 'train', max_len, limit_size = 10000, augment=True, skip_packages=[0])
    eval_dataset = MangaDataset(processor, 'test', max_len, limit_size = 10000, augment=False, skip_packages=range(1, 9999))
